...
const Achievements = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: achievementsData.filter(
        (a) =>
          a.category?.includes("Development") ||
          a.category?.includes("Design")
      ).length,
    ...
    },
    {
      ...
      label: "In Progress",
      value: achievementsData.filter(
        (a) => a.title.includes("Progress") || a.date.includes("Target")
      ).length,
      color: "text-orange-500",
    },
    {
      ...
      value: achievementsData.filter((a) => a.category === "Competition")
        .length,
      color: "text-orange-500",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <FadeIn className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A collection of my professional certifications, awards, and
              milestone achievements that showcase my commitment to continuous
          ...
          <FadeIn className="text-center">
            <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 md:p-12">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                These achievements represent my commitment to continuous
                improvement and staying current with the latest technologies and
