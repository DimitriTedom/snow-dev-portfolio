...
import { ArrowDown, Award, BookOpen, Calendar, GraduationCap, Trophy, UserCircle2 } from "lucide-react";
...
const About = () => {
  ...
  const education = [
    {
      degree: "GCE A-Levels in Mathematics, Futher Maths, Physics, Chemistry, and Biology",
      institution: "GBHS Mbalmayo",
      year: "2022-2023",
      description: "Graduated with honors,excited for plain time focus on web development and UI/UX design."
    }
  ];
  ...
  const achievements = [
    {
      title: "Figma Essential for User Interface and User Experience UI UX - 4hrs",
    ...
    {
      title: "Canva, Midjourney & ChatGPT: The Best Passive income in 2023 - 5,5hrs",
      url: "https://www.udemy.com/certificate/UC-a4de060f-0a3d-49b7-bd03-764a63e71f9a/"
    },
    {
      title: "Canva for Productivity: Design Faster Smarter with Time-Saving Techniques - 5,5hrs",
  ...
  const developerCvUrl = "https://drive.google.com/file/d/1jNOJV9wvaY-bsVfgdjKy0c03vGJ2G-hP/view?usp=sharing";
  const designerCvUrl = "https://drive.google.com/file/d/1nvFdAwskcbf8G1SLqhROOX2Rr_3TWa7-/view?usp=drive_link";
          ...
          <div className="max-w-4xl mx-auto">
            <FadeIn className="mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                Learn more about my journey, skills, and what drives me as a developer and designer.
              </p>
            </FadeIn>
              ...
              <div className="md:col-span-2">
                <SlideUp delay={0.1}>
                  <div className="mb-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      I'm Tedom Dimitri, a passionate MERN Stack Developer and UI/UX Designer with 2+ years of experience crafting digital experiences that blend functionality with aesthetic appeal. Based in Cameroon, I specialize in designing, building and deploy robust and scalable web applications using MongoDB, Express.js, React, and Node.js.
                    </p>
                    <p className="text-muted-foreground">
                      My approach combines technical expertise with design thinking from both graphic and UI/UX, allowing me to create solutions that are not only technically sound but also intuitive and visually appealing. I believe in creating software that solves real problems while providing delightful user experiences.
                    </p>
                  </div>
                </SlideUp>
                ...
                <SlideUp delay={0.2}>
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      My journey into the world of development began in 2023, where I discovered my passion for both code and design. What started as a curiosity evolved into a career that has allowed me to work with diverse clients and projects.
                    </p>
                    <p className="text-muted-foreground">
                      From developing e-commerce platforms to designing intuitive dashboards, I've had the opportunity to tackle complex challenges and grow both technically and creatively. Each project has contributed to my holistic understanding of what makes digital products successful.
                    </p>
                  </div>
                </SlideUp>
              </div>
            ...
            <div className="bg-muted p-8 rounded-lg text-center">
              <SlideUp>
                <h3 className="text-2xl font-bold mb-4">Interested in working with me?</h3>
