...
export const projectsData = [
  {
    ...
    code: "https://www.figma.com/design/iB4YKXeWuJByp0kGGwO2NY/ChezFlora?m=auto&t=O6e2pX2gqOn2ffqP-6",
  },
  {
    id: 2,
    ...
    code: "https://drive.google.com/drive/folders/14g4ic1DQILOlaA56JlWCiJg_XsXMSyG3?usp=sharing",
  },
  {
    id: 3,
    title: "ChezFlora E-commerce Web App",
    description:
      "This is a project 1 month project realised in ConCour conditions. This project required a deep understanding of user needs\n" +
    ...
    challenge:
      "The main challenge was to design, create and deploy in one month's time a system that could handle complex data both in front-end and backend part\n" +
    ...
    solution:
      "E-commerce platform with user-role-based authentication with real-time data visualization. I developed a strategic approach that included 4 days to craft a simple UI" +
    ...
    result:
      "The project was very well received by the jury, resulting in improved engagement metrics and positive feedback. Key performance indicators showed a significant\n" +
    ...
    code: "https://github.com/DimitriTedom/ChezFlora",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    challenge:
      "The main challenge was to design, code and deploy my first NEXTJS Project. A system that could handle CRUD data operations \n" +
      " while maintaining an intuitive and clean interface. Users needed to quickly\n" +
      "access information without feeling overwhelmed by the complexity of the\n" +
      "underlying structure, and of course, the prompts can be either suggested by Humman or Generated with AI",
    solution:
      "E-commerce platform with Google authentication with NEXTAUTHJS. I developed a strategic approach that included API communicaiton with LLAMA-3-VERSATILE through GROQ API" +
  ...
  },
  {
    ...
    code: "https://github.com/DimitriTedom/STS_TechStickers",
  },
];
